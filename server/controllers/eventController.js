...
export const approveEvent = catchAsync(async (req, res, next) => {
  ...
  try {
    await sendEmail({
      ...
      <p>Check it out!   <a href="https://www.tourmygarage.com/events" target="_blank" rel="noopener noreferrer">Upcoming Events</a>
      </p><p>Question?  Ask our pit crew: <a href="mailto:support@tourmygarage.com">support@tourmygarage.com</a></p>`,
    });
  } catch (err) {
